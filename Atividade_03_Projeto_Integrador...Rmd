---
title: Projeto_Integrador_Exercicio_03
...
```
1) Mostre com um comando e usando um gráfico a distribuicao das idades dessa amostra de alunos que fizeram ENADE em 2014. Comente o resultado.

```{r  include=FALSE}

hist(enade14$nu_idade, col="blue", main = "Histograma da distribuicao das idades dos candidatos do Enade")

```

 - Os candidatos entre 20 até 25 anos são os que mais fazem Enade e quando mais velhos são os candidatos, menor é a quantidade de participantes do Enade.
...
```
 - Descobrimos que o menor número de alunos do enade é de cor/raça: Indigena e o maior é de cor/raça: Branco.
...
```
- O gráfico mais adequado é o histograma, pois fornece clareza nos resultados da nota geral com a dimensão de alunos.
Em geral os alunos têm um mau desempenho, são poucos os alunos que tiraram notas acima de 600.
...
```
- Comprova que a nota dos alunos de faculdades públicas é levemente maior que a dos alunos das faculdades privadas.
