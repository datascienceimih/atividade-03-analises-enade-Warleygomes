...
```
 ...
 -os candidatos entre 20 até 25 anos são os que mais fazem enade e quando mais velho são os candidatos, menor é a quantidade de participante do enade.
...
Em geral os alunos tem um mau desempenho, são poucos os alunos que tiraram notas acima de 600.
